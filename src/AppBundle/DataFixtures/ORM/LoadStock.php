...
class LoadStock extends AbstractFixture implements OrderedFixtureInterface
{
  ...
  public function load(ObjectManager $manager)
  {
    ...
    $valeur = array(
      array(10, null, new \DateTime('2014-11-29 10:50:00'), null, null, 0, 0, 1),
      array(5, null, new \DateTime('2014-12-27 10:42:54'), null, null, 0, 0, 2),
      array(25, null, new \DateTime('2014-12-16 07:00:10'), null, null, 0, 0, 3),
      array(20, null, new \DateTime('2014-12-16 07:00:10'), new \DateTime('2014-12-20 14:12:00'), new \DateTime('2014-12-20 14:12:00'), 1, 0, 3),
      array(4, null, new \DateTime('2014-12-17 09:12:00'), null, null, 0, 0, 4),
      array(100, null, new \DateTime('2014-12-20 08:25:25'), null, null, 0, 0, 5),
